...
For example, to start a true database in a docker container, run:

    docker-compose -f src/main/docker/true.yml up -d

To stop it and remove the container, run:

    docker-compose -f src/main/docker/true.yml down
