...
import { NgxLoginModalComponent } from 'app/shared/login/login.component';
...
describe('Component Tests', () => {
    describe('LoginComponent', () => {
        let comp: NgxLoginModalComponent;
        let fixture: ComponentFixture<NgxLoginModalComponent>;
        ...
        beforeEach(async(() => {
            TestBed.configureTestingModule({
                ...
                declarations: [NgxLoginModalComponent],
                providers: [
                    {
                ...
                .overrideTemplate(NgxLoginModalComponent, '')
                .compileComponents();
        }));

        beforeEach(() => {
            fixture = TestBed.createComponent(NgxLoginModalComponent);
