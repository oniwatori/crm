...
import { NgxHealthCheckComponent } from 'app/admin/health/health.component';
import { NgxHealthService } from 'app/admin/health/health.service';

describe('Component Tests', () => {
    describe('NgxHealthCheckComponent', () => {
        let comp: NgxHealthCheckComponent;
        let fixture: ComponentFixture<NgxHealthCheckComponent>;
        let service: NgxHealthService;

        beforeEach(async(() => {
            TestBed.configureTestingModule({
                imports: [CrmTestModule],
                declarations: [NgxHealthCheckComponent]
            })
                .overrideTemplate(NgxHealthCheckComponent, '')
                .compileComponents();
        }));

        beforeEach(() => {
            fixture = TestBed.createComponent(NgxHealthCheckComponent);
            comp = fixture.componentInstance;
            service = fixture.debugElement.injector.get(NgxHealthService);
        });
